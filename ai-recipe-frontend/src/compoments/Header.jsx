            ...
            <ul className="navbar-nav me-auto mb-2 mb-lg-0">
              ...
              <li className="nav-item d-lg-none mt-2">
                {me ? (
                  ...
                  <div className="d-grid gap-2">
                    <button className="btn btn-outline-success w-100" onClick={() => go('/login-signup')}>로그인</button>
                    <button className="btn btn-success text-white w-100" onClick={() => go('/login-signup')}>회원가입</button>
                  </div>
                )}
              </li>
            </ul>
